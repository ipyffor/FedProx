...
X = [ i for i in range(sub_length)]
acc_loss = acc_loss[:sub_length]
acc_grad = acc_grad[:sub_length]
ln1, = plt.plot(X,acc_loss,color='red',linewidth=1.0,linestyle='-')
ln2, = plt.plot(X,acc_grad,color='blue',linewidth=1.0,linestyle='-')
